package spellcheck.Checkspelling_backup;///*
...
//        s = null;
//        try {
//            s = new Scanner(new BufferedReader(new FileReader("ngramdict/Englishdict.txt")));
//
//            while (s.hasNext()) {
...
//
//        try {
//            s = new Scanner(new BufferedReader(new FileReader("ngramdict/syllables.txt")));
//
...
//        try {
//            s = new Scanner(new BufferedReader(new FileReader("ngramdict/unigram_int.txt")));
//
//            String tmp;
//            tmp = s.next();
//
...
//        try {
//            r = new BufferedReader(new FileReader("ngramdict/bigram_int.txt"));
//            String tmp;
//            tmp = r.readLine();
...
//        count = 0;
//        try {
//            r = new BufferedReader(new FileReader("ngramdict/trigram_int.txt"));
//            String tmp;
//            tmp = r.readLine();
//            while ((tmp = r.readLine()) != null) {
...
//        count = 0;
//        try {
//            s = new Scanner(new BufferedReader(new FileReader("ngramdict/unigram_extractsign.txt")));
//            String tmp;
//            tmp = s.next();
//
...
//        count = 0;
//        try {
//            s = new Scanner(new BufferedReader(new FileReader("ngramdict/vietdict.txt")));
//            int tmp;
//            tmp = s.nextInt();
...
//    }
//
//    void processFile_v2(String fileNameIn, String outputFileName) throws Exception {
//        Scanner s = null;
//        try {
//            s = new Scanner(new BufferedReader(new FileReader(fileNameIn)));
////            s.useDelimiter(" |\\u2000|\\u2001|\\u2002|\\u2003|\\u2004|\\u2005|\\u2006|\\u2007|\\u2008|\\u2009|\\u200A|\\u200B|\\u2028|\\u2029|\\u3000|\\u00A0|\\uFEFF|\\n");
...
//        symbolMark3 = (tmp3_2.length() > 0 || (tmp4_1.length() > 0 && c4 != '@'));
//        //check the first two words
//        String result = process_v2("", "", first.toString(), second.toString(), third.toString());
//        if (first.toString().toLowerCase().compareTo(result.toLowerCase()) != 0) {
//            first.replace(0, first.length(), result);
//            resultSentence += "" + tmp1_1 + first + tmp1_2 + " ";
//            error_count++;
//        } else {
//            resultSentence += tmp_str1 + " ";
//        }
//        result = process_v2("", first.toString(), second.toString(), third.toString(), fourth.toString());
//        if (second.toString().toLowerCase().compareTo(result.toLowerCase()) != 0) {
//            second.replace(0, second.length(), result);
//            resultSentence += "" + tmp2_1 + second + tmp2_2 + " ";
//            error_count++;
//        } else {
...
//            remove_symbol(fifth, tmp5_1, tmp5_2);
//            symbolMark4 = (tmp4_2.length() > 0 || (tmp5_1.length() > 0 && c5 != '@'));
//            result = process_v2(first.toString(), second.toString(), third.toString(), fourth.toString(), fifth.toString());
////                System.out.println(tmp_str3);
//            if (third.toString().toLowerCase().compareTo(result.toLowerCase()) != 0 && c3 == '@') {
////                    System.out.println(first.toString() + " " + second.toString() + " " + third.toString() + " " + fourth.toString() + " " + fifth.toString() + " : " + result);
////                    Thread.sleep(50000);
...
//                // }
//                third.replace(0, third.length(), result);
//                resultSentence += "" + tmp3_1 + third + tmp3_2 + " ";
//            } else {
...
//        result = process_v2(second.toString(), third.toString(), fourth.toString(), "", "");
//        if (fourth.toString().toLowerCase().compareTo(result.toLowerCase()) != 0) {
//            fourth.replace(0, fourth.length(), result);
//            resultSentence += "" + tmp4_1 + fourth + tmp4_2 + " ";
//            error_count++;
//        } else {
